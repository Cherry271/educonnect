...
export const resourcesApi = {
  ...
  rate: (id: string, rating: number, review = '') => api.post(`/resources/${id}/rate`, { rating, review }),
...
export const discussionsApi = {
  ...
  comment: (id: string, content: string) => api.post(`/discussions/${id}/comments`, { content }),
};
...
export const messagesApi = {
  ...
  getMessages: (id: string, page = 1) => api.get(`/conversations/${id}/messages`, { params: { page } }),
  send: (id: string, content: string) => api.post(`/conversations/${id}/messages`, { content }),
};
...
export const aiApi = {
  ...
  quiz: (topic: string, num_questions = 5) => api.post('/ai/quiz', { topic, num_questions }),
  flashcards: (topic: string, num_cards = 10) => api.post('/ai/flashcards', { topic, num_cards }),
  ...
  moderate: (content: string) => api.post('/ai/moderate', null, { params: { content } }),
};
